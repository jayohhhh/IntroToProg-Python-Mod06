...
# Jonathan Ou, 5.17.2021. Added functions into Processing section
# Jonathan Ou, 5.17.2021. Added functions into IO section
# Jonathan Ou, 5.17.2021. Assembled functions callouts into main body of script
# Jonathan ou, 5.17.2021. revised processor functions, taking out unnecessary lines
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        ...
        list_of_rows.append(dicRow)  # adds new data to the end of the list currently stores
        return list_of_rows, 'Success'

    @staticmethod
    def remove_data_from_list(task, list_of_rows):
        for row in list_of_rows:
            if task in row.values():  # checks of the task is in any of the values of the list
                list_of_rows.remove(row)  # removes entire row in which value was flagged for removal
    ...
    def write_data_to_file(file_name, list_of_rows):
        ...
        for row in list_of_rows:  # iterates through the rows of the list
